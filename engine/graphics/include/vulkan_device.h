...
namespace engine::graphics::vulkan_utils
{
	struct VulkanDevice
	{
		...
		VkResult        createLogicalDevice(VkPhysicalDeviceFeatures enabledFeatures = {}, std::vector<const char*> enabledExtensions = {}, void* pNextChain = nullptr, bool useSwapChain = true, VkQueueFlags requestedQueueTypes = VK_QUEUE_GRAPHICS_BIT | VK_QUEUE_COMPUTE_BIT);
