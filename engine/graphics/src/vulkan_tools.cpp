...
#undef STR
		...
		VkPipelineStageFlags dstStageMask)
	{
		...
		VkImageMemoryBarrier imageMemoryBarrier = vulkan_utils::initializers::imageMemoryBarrier();
	...
	namespace tools
	{
		// Keep the tools namespace for backward compatibility if needed
		// Currently empty - all functions moved to parent namespace
	}
}