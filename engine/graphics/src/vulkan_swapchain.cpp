...
using namespace engine::graphics::vulkan_utils;
/** @brief Creates the platform specific surface abstraction of the native platform window used for presentation */
void VulkanSwapChain::initSurface(VkInstance instance, VkPhysicalDevice physicalDevice, VkDevice device, VkSurfaceKHR surface)
{
	setContext(instance, physicalDevice, device, surface);
...
void VulkanSwapChain::setContext(VkInstance instance, VkPhysicalDevice physicalDevice, VkDevice device, VkSurfaceKHR surface)
{
